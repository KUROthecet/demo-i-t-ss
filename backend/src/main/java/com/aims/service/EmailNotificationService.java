...
public class EmailNotificationService implements NotificationService {
    ...
    public void sendOrderConfirmation(String to, String name, String orderCode, long totalAmount) {
        sendHtml(to,
            ...
            buildOrderConfirmationHtml(name, orderCode, totalAmount));
    }
    ...
    public void sendOrderApproved(String to, String name, String orderCode) {
        sendHtml(to,
            ...
            buildOrderApprovedHtml(name, orderCode));
    }
    ...
    public void sendOrderRejected(String to, String name, String orderCode, String reason) {
        sendHtml(to,
            ...
            buildOrderRejectedHtml(name, orderCode, reason));
    }
    ...
    public void sendOrderCancelled(String to, String name, String orderCode, boolean refundIssued) {
        sendHtml(to,
            ...
            buildOrderCancelledHtml(name, orderCode, refundIssued));
    }
    ...
    public void sendPasswordReset(String to, String name, String newPassword) {
        sendHtml(to,
            ...
            buildPasswordResetHtml(name, newPassword));
    }
    ...
    private String buildOrderConfirmationHtml(String name, String orderCode, long totalAmount) {
        String body =
    ...
    private String buildOrderApprovedHtml(String name, String orderCode) {
        String body =
            "<p style='margin:0 0 24px;font-size:14px;color:rgba(255,255,255,0.6);line-height:1.8'>" +
    ...
    private String buildOrderRejectedHtml(String name, String orderCode, String reason) {
    ...
    private String buildOrderCancelledHtml(String name, String orderCode, boolean refundIssued) {
