...
export const routes: Routes = [
  ...
  {
    path: 'about',
    loadComponent: () => import('./features/customer/about/about.component').then(m => m.AboutComponent)
  },
  {
    path: 'contact',
    loadComponent: () => import('./features/customer/contact/contact.component').then(m => m.ContactComponent)
  },
  {
    path: 'shipping',
    loadComponent: () => import('./features/customer/shipping-policy/shipping-policy.component').then(m => m.ShippingPolicyComponent)
  },
  {
    path: 'faq',
    loadComponent: () => import('./features/customer/faq/faq.component').then(m => m.FaqComponent)
  },
  {
    path: 'returns',
    loadComponent: () => import('./features/customer/returns/returns.component').then(m => m.ReturnsComponent)
  },
